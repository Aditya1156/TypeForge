      ...
      <div className="grid md:grid-cols-4 gap-8 mb-8">
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex space-x-4">
            <a href="https://github.com/Aditya1156/TypeForge" className="text-text-secondary hover:text-accent transition-colors" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://twitter.com/typeforge" className="text-text-secondary hover:text-accent transition-colors" target="_blank" rel="noopener noreferrer">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
