...
const Results = ({ wpm, accuracy, consistency, errors, onRestart, onGetAiAnalysis, isAiLoading, errorDetails, onBackToMenu, hasNextDrill, onNextDrill, hasNextLesson, onNextLesson }: ResultsProps) => {
  ...
  return (
    <div className="flex flex-col items-center gap-8 p-8 bg-secondary rounded-lg shadow-lg text-text-primary w-full max-w-4xl">
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-4">
        ...
        <button
          onClick={onRestart}
          className="flex items-center gap-2 px-6 py-3 font-semibold text-primary bg-accent rounded-md hover:bg-accent/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-secondary focus:ring-accent transition-colors"
        >
